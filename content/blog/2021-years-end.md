...
I collaborated with him on the data structure that became `std.MultiArrayList` and contributed a significant amount of code to his [PR branch](https://github.com/ziglang/zig/pull/7920).
